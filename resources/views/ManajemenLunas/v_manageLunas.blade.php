...
<div class="card filter-card">
    ...
    <div class="search-upload-wrapper" style="margin-bottom: 30px; background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
        ...
        <!-- Inquiry Title -->
        <h4 style="margin-bottom: 15px; font-weight: 400;">Inquiry Dokumen Nasabah Lunas</h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Input Dokumen Nasabah Lunas</h1>
