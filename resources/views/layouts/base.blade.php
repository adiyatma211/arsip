...
<head>
    ...
    <style>
        ...
        .main-content {
            ...
            overflow-y: auto;
            display: none;
            /* disembunyikan saat loader aktif */
        }
    ...
    <div class="wrapper">
        ...
        <div id="sidebar">
            ...
            <ul>
                ...
                <li class="menu-item">
                    <a href="#"><i class="fas fa-user"></i> Manajemen Nasabah Aktif <i class="fas fa-chevron-down"
                            style="margin-left: 2rem;"></i></a>
                    <ul class="dropdown">
                        <li><a href="{{ route('NasabahAktif') }}" class="sidebar-btn"><i class="fas fa-plus-circle"></i>
                                Input Dokumen</a></li>
                    </ul>
                </li>
                <li class="menu-item">
                    <a href="#"><i class="fas fa-check-circle"></i> Manajemen Nasabah Lunas <i
                            class="fas fa-chevron-down" style="margin-left: 2rem;"></i></a>
                    <ul class="dropdown">
                        <li><a href="{{ route('NasabahLunas') }}"><i class="fas fa-plus-circle"></i> Input Dokumen</a>
                        </li>
                    </ul>
                </li>
                <li class="menu-item">
                    <a href="#"><i class="fas fa-trash"></i> Manajemen Pemusnahan <i class="fas fa-chevron-down"
                            style="margin-left: 2rem;"></i></a>
                    <ul class="dropdown">
                        <li><a href="{{ route('NasabahMusnah') }}"><i class="fas fa-plus-circle"></i> Input Dokumen</a>
                        </li>
                    </ul>
                </li>
                <li class="menu-item">
                    <a href="#"><i class="fas fa-folder-open"></i> Pinjam Dokumen <i class="fas fa-chevron-down"
                            style="margin-left: 2rem;"></i></a>
                    <ul class="dropdown">
                        <li><a href="{{ route('PinjamDokumen') }}"><i class="fas fa-plus-circle"></i> Input Pinjam
                                Dokumen</a></li>
                    </ul>
                </li>
        ...
        <div class="content-area">
            <!-- Top Bar -->
            <div class="top-bar"
                style="background-color: #ffffff; padding: 15px 25px; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
