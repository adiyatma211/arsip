...
<div class="card filter-card">
    ...
    <div class="search-upload-wrapper" style="margin-bottom: 30px; background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
        ...
        <!-- Inquiry Title -->
        <h4 style="margin-bottom: 15px; font-weight: 400;">Inquiry Dokumen Nasabah Pemusnahan</h4>
        ...
        <!-- Upload Title -->
        <h4 style="margin-bottom: 10px; font-weight: 400;">Manage Dokumen</h4>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            Upload Dokumen Nasabah Lunas
        </button>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            Manage Dokumen Nasabah Musnah
        </button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Input Dokumen Nasabah Musnah</h1>
